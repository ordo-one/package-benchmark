...
let benchmarks = {
    var thresholdTolerance: [BenchmarkMetric: BenchmarkThresholds]
    ...
    thresholdTolerance = [.mallocCountTotal: .init(relative: relative, absolute: absolute),
